      ...
      <main className="max-w-2xl mx-auto px-4 py-8 md:py-12">
        <div className="glass-panel p-6 md:p-8 shadow-2xl">
          <div className="flex flex-col md:flex-row md:items-start gap-6 mb-8">
            <div className="w-32 h-32 md:w-40 md:h-40 rounded-2xl bg-white/20 overflow-hidden shrink-0 mx-auto md:mx-0">
              {artist.imageUrl ? (
                <img
                  src={artist.imageUrl}
                  alt=""
            ...
            <div className="flex-1 text-center md:text-left min-w-0">
              ...
              {artist.bio && (
                <p className="text-sm text-white/70 mb-4 whitespace-pre-wrap max-w-lg">
                  {artist.bio}
                </p>
              )}
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  {artist.youtubeUrl && (
                    <a
                      ...
                      className="inline-flex items-center gap-2 rounded-xl px-3 py-2 bg-red-500/20 hover:bg-red-500/30 border border-red-400/30 text-sm font-medium text-red-200"
                    >
                  ...
                  {artist.websiteUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 rounded-xl px-3 py-2 bg-white/10 hover:bg-white/20 border border-white/20 text-sm font-medium text-white/80"
                    >
            ...
            {tracks.length === 0 ? (
              ...
              <ul className="space-y-2">
                {tracks.map((t) => (
                  ...
                  >
                    <span className="text-white/90 font-medium truncate flex-1">
                      {t.name}
                    </span>
                    <audio
                      controls
